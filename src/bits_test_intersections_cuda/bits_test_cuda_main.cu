...
#define PROGRAM_NAME "bits_test_cuda"
...
int main(int argc, char* argv[]) {
    ...
    if (!showHelp) {
        ...
        BitsTestCUDA *bc = new BitsTestCUDA(bedAFile, bedBFile, genomeFile, N);
        delete bc;
        return 0;
    }
    else {
...
void ShowHelp(void) {
    ...
    cerr << "Usage: " << PROGRAM_NAME << " [OPTIONS] -i <num intervals> -l <interval length> -g <bed/gff/vcf> -n <itters>" << endl << endl;
